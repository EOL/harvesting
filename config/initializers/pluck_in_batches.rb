# Taken from https://gist.github.com/siannopollo/03d646eb7525f7fce678#file-pluck_in_batches-rb ...as one comment
# mentions, this does NOT account for .where.not cases. # This assumes you are in Rails 4 and you can pluck multiple
# columns
class ActiveRecord::Relation
  ...
  def pluck_in_batches(*columns, batch_size: 1000)
    ...
    # It's cool. We're only taking in symbols no deep clone needed
