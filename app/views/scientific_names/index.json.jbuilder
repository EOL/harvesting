...
json.scientific_names @names do |name|
  ...
  json.extract! name, *%i(genus specific_epithet infraspecific_epithet infrageneric_epithet uninomial verbatim authorship publication remarks year hybrid surrogate virus parse_quality)
end
