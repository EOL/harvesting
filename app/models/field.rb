class Field < ActiveRecord::Base
  ...
  enum mapping:
    %i( to_ignored to_media_nodes_fk to_section to_media_type to_media_subtype to_license to_language_639_1
        ...
        to_occurrences_meta to_traits_pk to_traits_occurrence_fk to_traits_measurement_of_taxon to_traits_parent_pk
        to_traits_association_node_fk to_traits_predicate to_traits_value to_traits_units to_traits_statistical_method
        to_traits_source to_traits_reference_fk to_traits_meta )
