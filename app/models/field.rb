class Field < ActiveRecord::Base
  ...
  enum mapping:
    %i[ to_ignored
        ...
        to_nodes_publication to_nodes_source_reference to_nodes_page_id to_nodes_identifiers

        to_vernaculars_verbatim to_vernaculars_source_reference to_vernaculars_locality to_vernaculars_preferred
        to_vernacular_nodes_fk

        to_refs_pk to_refs_url to_refs_doi

        to_attributions_pk to_attributions_name to_attributions_role
        to_attributions_email to_attributions_url

        to_media_nodes_fk to_section to_media_type to_media_subtype to_license to_language_639_1
        ...
        to_media_rights_statement to_media_owner
