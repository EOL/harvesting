class Field < ActiveRecord::Base
  ...
  enum mapping: [ :to_ignored, :to_nodes_fk, :to_section, :to_media_type,
    :to_media_subtype, :to_license, :to_language_639_1, :to_language_639_2,
    :to_language_639_3, :to_format, :to_derived_from_reference,
    :to_bibliographic_citation, :to_attribution, :to_attributions_fk, :to_media_pk,
    :to_media_name, :to_media_description, :to_media_source_url,
    ...
    :to_vernaculars_locality, :to_vernaculars_preferred, :to_refs_pk,
    :to_refs_url, :to_refs_doi, :to_attributions_pk, :to_attributions_name,
    :to_attributions_role, :to_attributions_email, :to_attributions_url ]
