class Field < ActiveRecord::Base
  ...
  enum mapping:
    %i[ to_ignored to_media_nodes_fk to_section to_media_type to_media_subtype to_license to_language_639_1
        ...
        to_nodes_rank to_nodes_further_information_url to_taxonomic_status to_nodes_remarks to_nodes_publication
        to_nodes_source_reference to_vernaculars_verbatim to_vernaculars_source_reference to_vernaculars_locality
        to_vernaculars_preferred to_vernacular_nodes_fk to_refs_pk to_refs_url to_refs_doi to_attributions_pk
        to_attributions_name to_attributions_role to_attributions_email to_attributions_url
        to_occurrences_pk to_occurrences_node to_occurrences_sex to_occurrences_lifestage to_occurrences_lat
        to_occurrences_long to_occurrences_locality to_occurrences_meta to_traits_pk to_traits_occurrence_fk
        to_traits_measurement_of_taxon to_traits_parent_pk to_traits_association_node_fk to_traits_predicate
        to_traits_value to_traits_statistical_method to_traits_source to_traits_reference_fk to_traits_meta ]
